...
\def\Who{ Kishore Nanda } % Your name
\def\What{,  Professor } % Your title
\def\Where{ IIT Kanpur } % Your department/institution
\def\Address{123 Broadway} % Your address
\def\CityZip{Berkeley CA 12345} % Your city, zip code, country, etc
\def\Email{E-mail: kishore@referee.ac.in } % Your email address
\def\TEL{Phone: +91-8935020870 } % Your phone number
\def\URL{URL: kishore@referee.ac.in } % Your URL
