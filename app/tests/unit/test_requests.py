...
class RequestTests(TestCase):
    ...
    def test_guide_views(self):
        ...
        self.check_url('/user/panel/referees/indian/', GET, data = {'term' : 'a', 'thesis_id' : 1})
        self.check_url('/user/panel/referees/foreign/', GET, data = {'term' : 'a', 'thesis_id' : 1})
        ...
        self.check_url('/user/panel/referees/indian/', OTHER, status_code = STATUS_CODE_BAD_REQUEST)
        self.check_url('/user/panel/referees/foreign/', OTHER, status_code = STATUS_CODE_BAD_REQUEST)
    ...
    def test_non_student_views(self):
        ...
        #self.check_url('/user/panel/referees/indian/', ALL, data = {'term' : 'a', 'thesis_id' : 1}, status_code = STATUS_CODE_FORBIDDEN)
        #self.check_url('/user/panel/referees/foreign/', ALL, data = {'term' : 'a', 'thesis_id' : 1}, status_code = STATUS_CODE_FORBIDDEN)
    ...
    def test_login_required_views(self):
        ...
        self._check_login_redirect(response)
        #response = self.check_url('/user/panel/referees/indian/', GET, data = {'term' : 'a', 'thesis_id' : 1})
        #self._check_login_redirect(response)
        #response = self.check_url('/user/panel/referees/foreign/', GET, data = {'term' : 'a', 'thesis_id' : 1})
        #self._check_login_redirect(response)
